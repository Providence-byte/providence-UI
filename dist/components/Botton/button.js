...
export var Button = function (props) {
    var _a;
    var disabled = props.disabled, size = props.size, btnType = props.btnType, children = props.children, href = props.href, className = props.className, restProps = __rest(props, ["disabled", "size", "btnType", "children", "href", "className"]);
